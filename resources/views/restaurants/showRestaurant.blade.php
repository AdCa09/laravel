            ...
            <div class="space-y-10 md:space-y-16">
                ...
                <article class="flex flex-col lg:flex-row pb-10 md:pb-16 border-b">
                    ...
                    <div class="flex flex-col items-start mt-5 space-y-5 lg:w-7/12 lg:mt-0 lg:ml-12">
                        <h1 class="font-bold text-slate-900 text-3xl lg:text-5xl leading-tight">{{ $restaurant->name }}
                        </h1>
                        <a href=""
                        ...
                        <div class="form-container">
                            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Réserver une table</h2>
                ...
                <div class="bg-white max-w-4xl mx-auto rounded-lg shadow-lg flex">
                    ...
                    <div class="p-6 flex-1">
                        ...
                        <p class="text-gray-700 mb-4">Voici un petit texte descriptif pour donner plus d'informations
                            sur le contenu de la carte.</p>
                    </div>

                    <div class="relative w-48 flex-shrink-0">
                        <img class="w-full h-full object-cover rounded-r-lg" src="https://via.placeholder.com/500x300"
