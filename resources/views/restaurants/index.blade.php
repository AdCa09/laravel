        ...
        <header class="flex justify-between items-center space-x-5 text-slate-900">
            ...
            <form action="{{ route('index') }}"
                ...
                <input id="search" value="" class="px-2 w-full outline-none leading-none placeholder-slate-400"
                    type="search" name="search" placeholder="Rechercher un restaurant">
                <button>
                ...
                <article class="flex flex-col lg:flex-row pb-10 md:pb-16 border-b">
                    ...
                    <div class="flex flex-col items-start mt-5 space-y-5 lg:w-7/12 lg:mt-0 lg:ml-12">
                        ...
                        <p class="text-xl lg:text-2xl text-slate-600">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, sapiente eaque consectetur
                            rem nulla sit aliquam corporis labore obcaecati qui explicabo ipsum, mollitia ad iure,
                            eligendi id consequuntur earum. Tempore.
                        </p>
                        <a href=""
